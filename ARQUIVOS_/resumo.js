...
/* -----------------------------
   SELECT (onchange)
   Atualiza automaticamente ao mudar a opção
------------------------------ */

document.getElementById("escolaridade").onchange = function () {

    var campo_select = document.getElementById("escolaridade");
    var indice_selecionado = campo_select.selectedIndex;
    var valor_selecionado =
        campo_select.options[indice_selecionado].innerHTML;

    document.getElementById("escolaridade_selecionada").innerHTML =
        valor_selecionado;
};

/* -----------------------------
   CHECKBOX (onchange individual)
   Atualiza lista automaticamente
   sempre que qualquer checkbox mudar
------------------------------ */
